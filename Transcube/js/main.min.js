/*! transcube - v0.1.0 - 2014-09-05 */ ! function(a, b, c) {
	function d(c, f) {
		if (!b[c]) {
			if (!a[c]) {
	...
	1: [function(a) {
		a("./lib/class.js"), a("./lib/requestAnimFrame"), a("./analytics");
	...
	6: [function() {
		...
		}(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-79132566-4", "auto"), ga("send", "pageview")
	}, {}],
	4: [function(a, b) {
		var c = a("../config"),
			d = a("./input"),
			...
			i = Class.extend({
				...
				profiles: 0,
				init: function() {
					this.initCanvas(), this.game || (g.loadAll(f), g.onReady(function() {
						this.game || (this.game = new h(this.context))
					}, this)), this.initSounds(), e.initDebug(this.context, c.display.scale), e.dragNDrop(window), this.tick()
				},
				initSounds: function() {
					soundManager.setup({
						url: "media/swf/",
				...
				resize: function() {
					...
					var f = $("#ui").css("height").replace("px", "");
					$("#ui").css("padding-top", ~~(b / 2 - f / 2)), $("#canvas").css("left", ~~(a / 2 - this.canvas.width / 2) + "px").css("top", ~~(b / 2 - this.canvas.height / 2) + "px"), c.message.top = ~~(b / 2 - 50), this.game && c.display.scale != d && (e.resizeDebug(d), c.display.scale = d, g.resizeAll()), c.display.scale = d
				},
				update: function() {
		...
		var c = a("./config"),
			...
			j = Class.extend({
				...
				init: function(a) {
					...
					function h(a) {
						k && k.remove(), "intro" != j.currentLevelId ? ($("#menu .play:hidden").show(), $("#menu .restart").show()) : ($("#menu .restart").hide(), $("#menu .play").hide()), void 0 === a || a ? $("#levelselect").fadeIn() : $("#levelselect").hide()
					}
					e.bind("right", [f.D, f.RIGHT_ARROW]), e.bind("left", [f.Q, f.A, f.LEFT_ARROW]), e.bind("up", [f.Z, f.SPACE, f.UP_ARROW, f.W]), e.bind("down", [f.S, f.DOWN_ARROW]), e.bind("morph", [f.E]), e.bind("restart", [f.R]), e.bind("nextLevel", [f.N, f.ENTER]), $("#ui").fadeIn(1e3), $("#icons-top .right").fadeIn(1e3), this.context = a, this.loadLevel("intro");
					var j = this;
					...
					}), this.initLevels(), this.playMusic(), c.debug && (j.resetStats(), this.loadLevel(c.debug.level), g(!1), b()), this.ui = {
						showEnd: d,
						showGame: b,
						showLevels: h,
						showIntro: g
				...
				endLevel: function(a) {
					this.level.camera.max.x = 1 / 0, this.level.camera.min.y = -1 / 0, this.level.camera.max.y = 1 / 0, this.level.camera.min.x = -1 / 0, this.level.player.endLevel(this.level, a);
					var b = this,
						d = ~~(((new Date).getTime() - this.stats.starttime) / 1e3);
					ga("send", "event", "finish level", this.currentLevelId, d), $("#stats #time").text(d + ""), $("#stats #restarts").text(this.stats.restarts + ""), $("#stats #deaths").text(this.stats.deaths + ""), $("#stats #transforms").text(this.stats.transforms + ""), $("#morphs").fadeOut(), $("#icons-top .left").fadeOut();
					var e, f = $("#end").height();
					e = this.showMessage("Level Complete!", "#99FC87", 1500, {
						top: c.message.top - f,
						color: jQuery.Color("#FBCF95"),
						el: "#ui"
					}, !0, function() {
						var a = e.height();
						$("#end").css("top", c.message.top - f / 2 + a).fadeIn(400), b.waitingForNext = !0
					});
					var g = this.currentLevelData.next;
					if (!isNaN(g)) {
						var h = parseInt(localStorage.getItem("unlocked"));
						parseInt(g) > h && (localStorage.setItem("unlocked", h + 1), $($(".level")[parseInt(g)]).removeClass("locked"))
					}
				},
				retryLevel: function() {
				...
				loadLevel: function(a) {
					...
					if (b) {
						...
						var e = "";
						isNaN(a) || (e = parseInt(a) + 1 + ". "), $("#leveltitle").text(e + b.title), "0" == a && this.level.setActiveMorph(2), this.pauseGame(!1), this.waitingForNext = !1
					}
				},
				shake: function(a, b) {
				...
				update: function() {
					if (e.isPressed("restart") && !this.waitingForNext) {
						var a = this;
					...
					if (e.isPressed("nextLevel") && this.waitingForNext && (this.ui.showGame(!1), this.ui.showEnd(!1), this.nextLevel(), this.ui.showGame()), c.debug && e.isPressed(f.P) && (c.physics.debug = !c.physics.debug), this.level.update(this), this.shakeDuration > 0) {
	...
	13: [function(a, b) {
		...
		"./engine/perspective-layer": 19,
		"./engine/collision-layer": 20,
		"./engine/image-layer": 21,
		"./engine/animation": 22,
		"./config": 7,
		"./engine/camera": 23,
	...
	24: [function(a, b) {
		...
		"./actions/intro": 26,
		"./actions/changespawn": 27,
		"./actions/endlevel": 28,
		"./scenery/button": 29,
		"./scenery/door": 30,
		"./scenery/lava": 31,
		"./scenery/laser": 32,
		"./scenery/laserblock": 33,
		"./scenery/platform": 34,
		"./player": 35,
		"./control/test": 36,
		"./spawn/movable": 37,
	...
	37: [function(a, b) {
		...
		d.control = !1, d.pauseWhileMorph = !1, d.bgpos = {
			x: 120,
			y: 0
		}, d.info = "Kill yourself, leaving a pushable entity behind.", b.exports = d
	}, {
		"../entity": 43
	}],
	38: [function(a, b) {
	...
	39: [function(a, b) {
		...
		d.control = !1, d.pauseWhileMorph = !1, d.bgpos = {
			x: 60,
			y: 0
		}, d.info = "Spawns a static block you can jump on", b.exports = d
	}, {
		"../entity": 43
	}],
	40: [function(a, b) {
		...
		d.control = !1, d.pauseWhileMorph = !0, d.bgpos = {
			x: 180,
			y: 0
		}, d.info = "Spawns a floating block - paused while transforming", b.exports = d
	}, {
		"../entity": 43
	}],
	41: [function(a, b) {
		...
		d.control = !1, d.pauseWhileMorph = !1, d.bgpos = {
			x: 240,
			y: 0
		}, d.info = "Kill yourself, leaving a bounceable entity behind.", b.exports = d
	}, {
		"../entity": 43
	}],
	42: [function(a, b) {
		...
		d.control = !1, d.pauseWhileMorph = !1, d.bgpos = {
			x: 300,
			y: 0
		}, d.info = "Spawns a block that rises", b.exports = d
	}, {
		"../entity": 43
	}],
	43: [function(a, b) {
